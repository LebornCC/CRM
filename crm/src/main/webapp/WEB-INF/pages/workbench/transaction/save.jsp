...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function () {
		$("#create-stage").change(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/transaction/getPosssibilityByStage.do',
				data:{
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="5f709531ec174d278a4929e8d1796c7c">
				<input type="text" class="form-control" id="create-activityName" value="测试111">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" class="form-control" id="create-contactsId" value="2ff3574e4b3f49299e505f20ba078b8b">
				<input type="text" class="form-control" id="create-contactsName" value="zxczxc23">
			</div>
		</div>
