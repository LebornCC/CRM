...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityBtn").click(function () {
			$("#searchActivityForConvertBtn").val("");
			$("#tBody").html("");
			$("#searchActivityModal").modal("show");
		});

		$("#searchActivityForConvertBtn").keyup(function () {
			var activityName = this.value;
			var clueId ='${clue.id}';

			$.ajax({
				url:'workbench/clue/selectActivityForConvert.do',
				data:{
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input  id="searchActivityForConvertBtn" type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
